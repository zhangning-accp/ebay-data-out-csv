...
//    }
     ...
     * @return
     * https://i.ebayimg.com/images/g/TE4AAOSwo4pYEctQ/s-l600.jpg
     */
...
//    }
    ...
    public static List<File> files(String folder) {
        File file = new File(folder);
    ...
    public static void main(String [] args) {
        ...
        Map<String,List<File>> map = getFiles("C:/export");;
